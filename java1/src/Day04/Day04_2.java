...
public class Day04_2 {
	...
	System.out.println("3의배수의 합계 : "+배수합);
		 ...
		 */
		System.out.print("[문제6] 줄수 입력 : "); int 문제6 = 입력객체.nextInt();
		for( int i = 1 ; i<=문제6 ; i++ ) {
		...
		/*						i			b						S
		    	  ...
		    	  *****			i = 3		b = 1 2					S = 1 2 3 4 5 			i*2 = 6 - 1 = 5
  			 	...
  			 	*********		i = 5 		b = 					S = 1 2 3 4 5 6 7 8 9	i*2 = 10 - 1 = 9
  			 								최대줄수[입력값]-현재줄수		S <= i*2-1
		 */
		System.out.print("[문제7] 줄수 입력 : "); int 문제7 = 입력객체.nextInt();
		for( int i = 1 ; i<=문제7 ; i++ ) {
			// 공백찍기
		...
		/*
		  	   ...
		  	   66666666666
		 */
		System.out.print("[문제8] 줄수 입력 : "); int 문제8 = 입력객체.nextInt();
		for( int i = 1 ; i<=문제8 ; i++ ) {
			// 공백찍기
			for( int b = 1 ; b<=문제8-i ; b++ ) { System.out.print(" ");}
			// 별찍기
			for( int s = 1 ; s<=i*2-1 ; s++ ) {System.out.print(i);} // 별 대신 i 출력 
			// 줄바꿈
			System.out.println();
		}
		      ...
		      *****		i = 3	b = 1 2			s = 1 2 3 4 5 				10 - 5
		       ***		i = 4	b = 1 2 3		s = 1 2 3					10 - 7
		        *		i = 5	b = 1 2 3 4 	s = 1 						10 - 9
		        				b<=i-1			s <= 최대줄수 * 2 - (i*2 -1)
		 */
		// 문제10 : for줄수() {    for()공백{}  for()별{}  }
		/*
		  	 *     *
		  	  *   *
		       * *
